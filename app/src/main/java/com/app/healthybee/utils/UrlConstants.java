...
public class UrlConstants {
    ...
    public static String createUser = "https://healthybee-mob-api.herokuapp.com/users?access_token=3biGa1hRAPnwN7Ad9hdMOhm6NGBGC4MU";
    public static String authUser = "https://healthybee-mob-api.herokuapp.com/auth?access_token=3biGa1hRAPnwN7Ad9hdMOhm6NGBGC4MU";
